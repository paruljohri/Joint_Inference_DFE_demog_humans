...
t3 = h*(100/(2*Ne))
t4 = h*1.0
l_specific_positions = [1, 500, 5000] #Some specific position that you want to get B and pi at
...
for posn_specific in l_specific_positions:
...
print ("B at 50% recovery position " + str(numbp50) + ":" + '\t' + str(calculate_B(numbp50)))
