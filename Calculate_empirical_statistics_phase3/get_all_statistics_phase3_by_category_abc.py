...
#read in all files:
f_stats_exon = open("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_exon_" + cat + ".bigwinsummary", 'r')
f_stats_5p = open("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_5p_" + cat + ".bigwinsummary", 'r')
f_stats_3p = open("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_3p_" + cat + ".bigwinsummary", 'r')
f_div_exon = open("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_exon_" + cat + ".divergence", 'r')
f_div_5p = open("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_5p_" + cat + ".divergence", 'r')
f_div_3p = open("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_3p_" + cat + ".divergence", 'r')


result = open("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_" + cat + "_abc.txt", 'w+')
