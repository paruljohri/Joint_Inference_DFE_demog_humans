...
#Rscript ./get_final_statistics_phase3.R exon
...
t <- read.table(paste("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_", region, "_", cat, ".stats", sep=""),h=T)
...
write.table(stats, file=paste("/home/pjohri1/BgsDfeDemo_Human/Humans/Exons/Numbp50/YRI_50/STATS_FILTERED/by_category/human_phase3_bigwindow_", region, "_", cat, ".bigwinsummary", sep=""), sep="\t", quote=F)
